...
if __name__ == '__main__':
    ...
    parser.add_argument('--case', required=True, choices=['atari', 'dd'],
    ...
    #parser.add_argument('--object_store_memory', type=int, default=1024*1024)#default=150 * 1024 * 1024 * 1024, help='object store memory')
    ...
    if args.case == 'atari':
        ...
        from config.dd import game_config
    else:
